//! Error types for XZ/LZMA CLI operations.
...
pub enum Error {
    ...
    #[error("{path}: Cannot determine compression format: {message}")]
    FormatDetection {
        /// Path to the file
        path: String,
        /// Error message
